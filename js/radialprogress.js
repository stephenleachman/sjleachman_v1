...
function RadialProgress(container,cfg){
	...
	this.colorText=cfg.colorText==undefined?"#fefefe":cfg.colorText;
	this.colorText=cfg.colorText==undefined?"#fefefe":cfg.colorText;
	...
	this.animationSpeed=cfg.animationSpeed==undefined?.5:cfg.animationSpeed>0?cfg.animationSpeed:1;
